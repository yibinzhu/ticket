...
public class MonthYearPicker {
    ...
    public MonthYearPicker(Activity activity) {
        ...
        this.view = activity.getLayoutInflater().inflate(R.layout.widget_month_year_picker, null);
    }
    ...
    public void build(int selectedMonth, int selectedYear, DialogInterface.OnClickListener positiveButtonListener,
        ...
        builder.setTitle("날짜선택 하세요");
        builder.setPositiveButton("확인", positiveButtonListener);
        builder.setNegativeButton("취소", negativeButtonListener);
        build = true;
