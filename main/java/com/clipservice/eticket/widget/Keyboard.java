...
/**
 * Created by clip-771 on 2018-01-17.
 */
...
public class Keyboard extends LinearLayout implements View.OnClickListener {
    ...
    private Keyboard(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        initialButton(context,attrs);
    }

    public void initialButton(Context context, AttributeSet attrs){
        LayoutInflater.from(context).inflate(R.layout.widget_keyboard,this,true);
